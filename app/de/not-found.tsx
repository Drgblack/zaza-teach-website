      ...
      <div className="w-full max-w-4xl">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <Card className="hover:shadow-lg transition-shadow">
            ...
            <CardContent className="space-y-3">
              <Link 
                href="/de/resources/lesson-plan-template" 
              ...
              <Link 
                href="/de/resources/ai-teaching-prompts" 
                className="block p-2 rounded hover:bg-gray-50 transition-colors"
              >
                <div className="font-medium text-blue-600 hover:text-blue-800">
              ...
              <Link 
                href="/de/resources/assessment-rubric-guide" 
                className="block p-2 rounded hover:bg-gray-50 transition-colors"
              >
                <div className="font-medium text-blue-600 hover:text-blue-800">
        ...
        <div className="mt-12 text-center text-gray-500">
          <p className="text-sm">
            ...
            <Link href="/de/blog" className="text-blue-600 hover:text-blue-800 underline">
              {t('notFound.searchFeature')}
            </Link>{' '}
            {t('notFound.or')}{' '}
            <Link href="/de/contact" className="text-blue-600 hover:text-blue-800 underline">
