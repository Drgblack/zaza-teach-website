  ...
  const handlePlanAction = async (plan: CheckoutPlan) => {
    ...
    if (plan === 'free') {
      try {
        ...
        window.alert('Der kostenlose Start konnte nicht geöffnet werden. Bitte versuchen Sie es erneut.');
      }
      return;
    }
    ...
    try {
      ...
      window.alert('Checkout konnte nicht gestartet werden. Bitte versuchen Sie es erneut.');
    } finally {
      ...
      <div className="relative pt-24 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl lg:text-6xl">
            {heroTitle.includes('Unterricht wieder Freude macht') ? (
              <>
                {heroTitle.split('damit Unterricht wieder Freude macht')[0]}
                damit <span className="bg-gradient-to-r from-[#E0115F] to-[#8A2BE2] bg-clip-text text-transparent">
                  Unterricht wieder Freude macht
                </span>
                {heroTitle.split('damit Unterricht wieder Freude macht')[1]}
              </>
            ) : heroTitle}
          </h1>
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 lg:gap-12">
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 relative">
            <div className="text-center mb-8">
              ...
              >
                {TEACH_SALES_ENABLED ? plans?.free?.cta || 'Kostenlos starten' : earlyAccessLabel}
              </button>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl border-2 border-blue-500 p-8 relative transform scale-105">
            ...
            <div className="text-center mb-8">
              ...
              <button
                ...
                className="w-full bg-blue-600 text-white px-8 py-4 rounded-xl font-semibold hover:bg-blue-700 transition-colors inline-block text-center text-lg disabled:cursor-not-allowed disabled:opacity-70"
              >
                {TEACH_SALES_ENABLED ? plans?.pro?.cta || 'Pro starten' : earlyAccessLabel}
              </button>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 relative">
            <div className="text-center mb-8">
              ...
              >
                {TEACH_SALES_ENABLED ? plans?.bundle?.cta || 'Bundle holen' : earlyAccessLabel}
              </button>
            </div>
