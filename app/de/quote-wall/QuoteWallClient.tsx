...
export default function QuoteWallClient() {
  ...
  // Get the quotes from translations
  const quotes = Array.from({ length: 6 }, (_, i) => ({
    text: t(`quoteWall.quotes.${i}.text`),
    author: t(`quoteWall.quotes.${i}.author`),
    role: t(`quoteWall.quotes.${i}.role`),
    school: t(`quoteWall.quotes.${i}.school`)
  }));
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="bg-gradient-to-r from-purple-100 to-blue-100 rounded-lg p-8 text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">
            {t('quoteWall.community.title')}
          </h2>
          <p className="text-gray-700 mb-6">
            {t('quoteWall.community.description')}
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              {t('quoteWall.community.shareStory')}
            </Link>
          </div>
        </div>
      </div>
