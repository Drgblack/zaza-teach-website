...
const resources = [
  {
    ...
    viewUrl: '/de/resources/lesson-plan-template',
    icon: FileText,
    category: 'Planning',
  ...
  },
  {
    ...
    viewUrl: '/de/resources/assessment-rubric-guide',
    icon: CheckSquare,
    category: 'Assessment',
  ...
  },
  {
    ...
    viewUrl: '/de/resources/classroom-management-tips',
    icon: Users,
    category: 'Management',
  ...
  },
  {
    ...
    viewUrl: '/de/resources/student-engagement-activities',
    icon: BookOpen,
    category: 'Activities',
  ...
  },
  {
    ...
    viewUrl: '/de/resources/ai-teaching-prompts',
    icon: Zap,
    category: 'AI Tools',
  ...
  },
  {
    ...
    viewUrl: '/de/resources/time-saving-checklist',
    icon: Clock,
...
export default function ResourcesPage() {
  const locale = 'de'; // Since this is in the /de folder
  return (
