      ...
      <div className="max-w-4xl mx-auto px-4 print:px-0">
        ...
        <div className="bg-white p-8 print:p-0">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-gray-900 mb-2">LESSON PLAN TEMPLATE</h1>
            <p className="text-sm text-gray-700">Free resource from Zaza Teach</p>
          </div>

          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="border-2 border-gray-300 p-4 rounded-lg bg-gray-50">
                <strong className="text-gray-900">Subject:</strong> <span className="text-gray-800">___________________________</span>
              </div>
              <div className="border-2 border-gray-300 p-4 rounded-lg bg-gray-50">
                <strong className="text-gray-900">Grade Level:</strong> <span className="text-gray-800">_____________________</span>
              </div>
              <div className="border-2 border-gray-300 p-4 rounded-lg bg-gray-50">
                <strong className="text-gray-900">Date:</strong> <span className="text-gray-800">_____________________________</span>
              </div>
              <div className="border-2 border-gray-300 p-4 rounded-lg bg-gray-50">
                <strong className="text-gray-900">Duration:</strong> <span className="text-gray-800">________________________</span>
              </div>
            </div>
