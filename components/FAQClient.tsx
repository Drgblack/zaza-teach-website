...
export default function FAQClient() {
  ...
  // Helper to safely get FAQ array from translations
  const getFAQArray = (categoryKey: string): FAQ[] => {
    const faqs = t(`faq.categories.${categoryKey}.faqs`);
  ...
  const faqCategories: FAQCategory[] = [
    {
      ...
      icon: 'Book',
      color: 'purple',
      faqs: getFAQArray('gettingStarted')
    },
    {
      category: t('faq.categories.featuresAndFunctionality.title'),
      icon: 'MessageCircle',
      color: 'blue',
      faqs: getFAQArray('featuresAndFunctionality')
    },
    {
      category: t('faq.categories.collaborationAndSupport.title'),
      icon: 'Users',
      color: 'green',
      faqs: getFAQArray('collaborationAndSupport')
    },
    {
      category: t('faq.categories.securityAndPrivacy.title'),
      icon: 'Shield',
      color: 'orange',
      faqs: getFAQArray('securityAndPrivacy')
    },
    {
      category: t('faq.categories.aboutFounderAndCompany.title'),
      icon: 'UserCheck',
      color: 'purple',
      faqs: getFAQArray('aboutFounderAndCompany')
    }
  ];
