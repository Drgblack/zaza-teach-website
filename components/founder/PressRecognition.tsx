...
export function PressRecognition() {
  return (
    <section className="space-y-6">
      <h2 className="text-2xl font-semibold">Press & Recognition</h2>
      <div className="grid gap-6 sm:grid-cols-2">
        {items.map((item) => {
          const IconComponent = item.icon;
          return (
            <Card className="rounded-2xl shadow-lg" key={item.title}>
              <CardHeader>
      ...
      <div className="mt-8">
        <p className="text-sm text-muted-foreground mb-4 text-center">Featured in</p>
